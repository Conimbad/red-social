...
<div class="container mx-auto md:flex">
    ...
    <div class="md:w-1/2 p-5">
        <div class="shadow bg-white p-5 mb-5">
            ...
            @if (session('mensaje'))
            <div class="bg-green-500 p-2 rounded-lg mb-6 text-white text-center uppercase ofnt-bold">
                {{ session( 'mensaje' ) }}
            </div>
            @endif
            <form action=" {{ route('comentarios.store', [ 'user' => $user->username, 'post' => $post ]) }} " method="POST">
                ...
                <div class="mb-5">
                    ...
                    <textarea id="comentario" name="comentario" placeholder="Escribe un comentario" class="border p-3 w-full rounded-lg @error('name') border-red-500 @enderror"></textarea>
                    @error('comentario')
